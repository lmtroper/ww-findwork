...
const page = () => {
  ...
  return (
    ...
    <div className='w-[800px]'>
        ...
        Based on your resume we found the following skills, which of these would you like to do in your next role?
        </div>
    </div>
    <div className='mb-10 max-w-[650px]'>
        <div className='flex flex-wrap justify-center'>
            {skills.map(skill => (
                <div 
                    key={skill}
                    className={`skill-tag cursor-pointer ${selectedSkills.includes(skill) ? "bg-[#063C5C] text-white" : 'text-[#063C5C]'}`}
